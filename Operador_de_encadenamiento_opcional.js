...
const gameSystem = {
  ...
  specs: {
    cpu: "AMD Ryzen Zen 2",
    gpu: "AMD RRadeon RDNA 2",
  },
};

console.log(gameSystem.name); // PS5
console.log(gameSystem.specifications); // Undefined
//console.log(gameSystem.specifications.ram); // ❌ Uncaught TypeError: Cannot read property 'ram' of undefined
...
console.log("price" in gameSystem); // true
console.log("specification" in gameSystem); // false

if ("specification" in gameSystem) {
  console.log(gameSystem.specification.ram);
} else {
  console.log("No hay especificaciones");
}
...
console.log("specifications" in gameConsole); // true
//gameConsole.specifications.ram; // ❌ Uncaught TypeError: Cannot read property 'ram' of undefined
...
if (
  "specifications" in gameConsole &&
  gameConsole.specifications !== undefined &&
  gameConsole.specifications !== null
) {
  console.log(gameConsole.specifications.ram);
} else {
  console.log("No hay especificaciones");
}

/*MUCHO CODIGO ppara algo tan simple. Por suerte, existe una forma más sencilla de hacerlo
...
console.log(gamesSystem.specification?.cpu); // Undefined
console.log(gamesSystem.specs?.cpu); // AMD Ryzen Zen 2
...
/* la forma clásica de acceder a una propiedad anidad de forma segura
let email = undefined

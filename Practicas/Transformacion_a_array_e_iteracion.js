...
const propiedades = Object.keys(Thor);
console.log(propiedades.length); // 3
...
const valores = Object.values(Thor);
...
const entries = Object.entries(Thor);
...
const entrie = Object.entries(Thor);
